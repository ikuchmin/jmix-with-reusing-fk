package com.company.ub_with_double_keys.test_support;

import com.company.ub_with_double_keys.UbWithDoubleKeysApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.ub_with_double_keys.screen")
@ContextConfiguration(classes = {UbWithDoubleKeysApplication.class, UiTestAssistConfiguration.class})
